           ...
           return false
			...
			switch(command) { 
				...
				case 'pornhub':
					...
					reply(ind.wait())
					alan = await getBuffer(`https://api.zeks.xyz/api/pornhub?text1=${porn}&text2=${hub}`)
                ...
                case 'glitchtext':
					...
					var gli = gh.split("&")[0];
					var tch = gh.split("&")[1];
					if (args.length < 1) return reply(`「❗」Contoh : ${prefix}glitchtext Sun & Gans`)
					reply(ind.wait())
				...
				case 'pubglogo':
					...
					if (args.length < 1) return reply(`「❗」Contoh : ${prefix}glitchtext Sun & Gans`)
					reply(ind.wait())
					buffer = await getBuffer(`https://api.zeks.xyz/api/pubglogo?text1=${pu}&text2=${bg}&apikey=apivinz`)
					client.sendMessage(from, buffer, image, {quoted: mek})
					await limitAdd(sender)
				break
			    case 'bpink':
			        if (!isRegistered) return reply(ind.noregis())
			        if (isLimit(sender)) return reply(ind.limited(pushname))
			        if (args.length < 1) return reply(ind.wrongf())
			        ligh = body.slice(7)
			        if (ligh.length > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
			        reply (ind.wait())
			        lucu = await getBuffer(`https://api.zeks.xyz/api/logobp?text=${ligh}&apikey=apivinz`)
			        client.sendMessage(from, lucu, image, {quoted: mek})
			        await limitAdd(sender)
				break
				case 'goldbutton':
			        if (!isRegistered) return reply(ind.noregis())
			        ...
			        if (ligh.length > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
			        reply (ind.wait())
			        tulul = await getBuffer(`https://lolhuman.herokuapp/api/ephoto1/goldplaybutton?text=${ligh}&apikey=2e754c4330d1e5f46ca158c8`)
			        client.sendMessage(from, tulul, image, {quoted: mek})
			        await limitAdd(sender)
				break
				case 'hekerserti':
			        if (!isRegistered) return reply(ind.noregis())
			        ...
			        if (ligh.length > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
			        reply (ind.wait())
			        luwik = await getBuffer(`https://onlydevcity.xyz/HekerSerti/img.php?nama=${args[0]}`,{method: 'get'})
			        client.sendMessage(from, luwik, image, {quoted: mek})
			        await limitAdd(sender)
				break
				case 'gayserti':
			        if (!isRegistered) return reply(ind.noregis())
			        ...
			        if (ligh.length > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
			        reply (ind.wait())
			        likok = await getBuffer(`https://onlydevcity.xyz/GaySerti/img.php?nama=${args[0]}`,{method: 'get'})
			        client.sendMessage(from, likok, image, {quoted: mek})
			        await limitAdd(sender)
				break
				case 'mlserti':
			        if (!isRegistered) return reply(ind.noregis())
			        ...
			        if (ligh.length > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
			        reply (ind.wait())
			        lurik = await getBuffer(`https://onlydevcity.xyz/MLTourSerti/img.php?nama=${args[0]}`,{method: 'get'})
			        client.sendMessage(from, lurik, image, {quoted: mek})
			        await limitAdd(sender)
				break
				case 'ffserti':
			        if (!isRegistered) return reply(ind.noregis())
			        ...
			        if (ligh.length > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
			        reply (ind.wait())
			        lukir = await getBuffer(`https://onlydevcity.xyz/FFSerti2/img.php?nama=${args[0]}`,{method: 'get'})
			        client.sendMessage(from, lukir, image, {quoted: mek})
			        await limitAdd(sender)
				break
				case 'pubgserti':
			        if (!isRegistered) return reply(ind.noregis())
			        ...
			        if (ligh.length > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
			        reply (ind.wait())
			        huek = await getBuffer(`https://onlydevcity.xyz/PubgTourSerti4/img.php?nama=${args[0]}`,{method: 'get'})
			        client.sendMessage(from, huek, image, {quoted: mek})
			        await limitAdd(sender)
				break
				case 'logoff':
			        if (!isRegistered) return reply(ind.noregis())
			        ...
			        if (ligh.length > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
			        reply (ind.wait())
			        liwik = await getBuffer(`https://api.zeks.xyz/api/epep?text=${ligh}&apikey=apivinz`)
			        client.sendMessage(from, liwik, image, {quoted: mek})
			        await limitAdd(sender)
				break
				case 'flogo':
			        if (!isRegistered) return reply(ind.noregis())
			        ...
			        if (ligh.length > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
			        reply (ind.wait())
			        larak = await getBuffer(`https://api.zeks.xyz/api/tfire?text=${ligh}&apikey=apivinz`)
			        client.sendMessage(from, larak, image, {quoted: mek})
			        await limitAdd(sender)
				break
				case 'wlogo':
			        if (!isRegistered) return reply(ind.noregis())
			        ...
			        if (ligh.length > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
			        reply (ind.wait())
			        larak = await getBuffer(`https://api.zeks.xyz/api/dropwater?text=${ligh}&apikey=apivinz`)
			        client.sendMessage(from, larak, image, {quoted: mek})
			        await limitAdd(sender)
				break
				case 'hlogo':
			        ...
			        if (ligh.length > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
			        reply (ind.wait())
			        lurik = await getBuffer(`https://api.zeks.xyz/api/gneon?text=${ligh}&apikey=apivinz`)
			        client.sendMessage(from, lurik, image, {quoted: mek})
			        await limitAdd(sender)
				break
				case 'nulis':
				...
				//tobz 
				case 'lirik':
				anu = await fetchJson(`http://scrap.terhambar.com/lirik?word=${body.slice(6)}`,{method: 'get'})
            ...
            case 'bitly':
               ...
               if (data.error) return reply(data.error)
				...
				case 'igstalk':
                   if (!isRegistered) return reply(ind.noregis())
                   if (isLimit(sender)) return reply(ind.limitend(pusname))
                     hmm = await fetchJson(`https://api.zeks.xyz/api/igstalk?=${body.slice(9)}&apikey=apivinz`)
				...
				case 'quotes':
					if (!isRegistered) return reply(ind.noregis())
					if (isLimit(sender)) return reply(ind.limitend(pusname))
					anu = await fetchJson(`https://docs-jojo.herokuapp.com/api/randomquotes`, {method: 'get'})
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					anu = await fetchJson(`https://freerestapi.herokuapp.com/api/v1/yt?url=${args[0]}`, {method: 'get'})
					if (anu.error) return reply(anu.error)
...
• Limit: ${limitawal-updated.limit}`
           ...
           case 'demote':
                ...
                //if (!isPublic) return reply(mess.only.publikG)
                    ...
                    client.sendMessage('6281370504372@s.whatsapp.net', options, text, {quoted: mek})
